...
@section('heading', 'Add Supervisor')

@section('content')
    <div class="max-w-2xl bg-white rounded-2xl border border-line p-8">
        <form method="POST" action="{{ route('coordinator.supervisors.store') }}" class="space-y-5">
            @csrf
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="bg-ink text-white text-sm font-medium px-6 py-3 rounded-xl hover:bg-ink-soft transition">Add supervisor</button>
